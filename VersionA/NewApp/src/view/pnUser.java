...
public class pnUser extends javax.swing.JPanel {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        User objUser = new User(0, username,"", fullname, active);
        ...
        switch(function){
            case "add":
                if(objUser.getUsername().isEmpty()){
                    JOptionPane.showConfirmDialog(new pnCat(), "Chưa nhập tên đăng nhập","Thông báo",JOptionPane.WARNING_MESSAGE);
                    result = false;
                }
            ...
            case "edit":
                if(objUser.getUsername().isEmpty()){
                    JOptionPane.showConfirmDialog(new pnCat(), "Vui lòng không bỏ trống tên đăng nhập","Thông báo",JOptionPane.WARNING_MESSAGE);
                    result = false;
                }
                break;
            case "del":
